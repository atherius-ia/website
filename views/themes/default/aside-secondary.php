...
<aside id="aside-secondary">
		  ...
		  <ul class="post-list">
				<li class="clearfix" style="padding:0;">
				    <div class="sambut">
					 ...
					 <p><?=strip_tags(substr($this->setting['sambutan_kepala_sekolah'], 0, 180));?>...</p>
	 ...
	 <div class="widget-title">
		  <h4><span><?=$menu['jajak_pendapat'] == '' ? 'POLING PENDAPAT' : $menu['jajak_pendapat'];?></span> <i class="fa fa-star"></i></h4>
	 </div>
	 <div class="widget">
