	...
	<div id="sekolahku" class="clearfix">
	    <div class="kepsek">
		    <?php if ($this->uri->segment(2) != 'sambutan_kepala_sekolah') { ?>
				...
				<p><?=strip_tags(substr($this->setting['sambutan_kepala_sekolah'], 0, 280));?>...</p>
				<div class="kep-more">
	    ...
	    <div class="poll">
		    <h4><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i> <?=$menu['jajak_pendapat'] == '' ? 'POLING PENDAPAT' : $menu['jajak_pendapat'];?></h4>
