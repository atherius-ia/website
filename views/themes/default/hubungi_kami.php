...
<script
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCWrN7pKxbHGJO1AsG_l8PmlaX3on2TJoU&callback=initMap">
</script>
<script>
...
<section id="main-content">
	...
	<div class="widget">
		<div id="googleMap" style="height:400px;margin-left: auto;margin-right: auto;padding-left: 15px;padding-right: 15px"></div>
		<br>
